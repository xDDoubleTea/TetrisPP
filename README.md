...
> The linux build was only tested on ubuntu and it uses apt as the package manager. There is no install script provided so good luck :)
...
- [ ] Boss fights
- [ ] More music
- [ ] Load assets at the start of the game instead of after starting the game
